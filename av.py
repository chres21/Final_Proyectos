import io
archivo_texto = open("avion.txt", "a")
...
while(True):
	try:
		...
		if clase == 1:
			...
			archivo_texto.write("Elijio primera clase \n")
			break
		if clase == 2:
			print("Elijio segunda clase \n")
			archivo_texto.write("Elijio segunda clase \n")
			break
		if clase == 3:
			print("Elijio tercera clase \n")
			archivo_texto.write("Elijio tercera clase \n")
			break
...
while(True):
	...
	try:
		...
		if servicio == 1: 
			...
			archivo_texto.write("Ha elejido comida como un servicio especial\n")
			break
		if servicio == 2:
			print("Ha elejido bebida como un servicio especial\n")
			archivo_texto.write("Ha elejido bebida como un servicio especial\n")
			break
		if servicio == 3:
			print("Ha elejido pelicula como un servicio especial\n")
			archivo_texto.write("Ha elejido pelicula como un servicio especial\n")
			break
		elif servicio >= 4:
...
archivo_texto.write("Usted ha elejido la clase: " + str(clase) + " y una cantidad de: " + str(servicio1) + " servicios espciales. \n")
